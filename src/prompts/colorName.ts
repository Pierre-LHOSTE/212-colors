...
Provide a brief, accurate description of the color represented by the hex code "{color-hex}". Focus on its shade, intensity, and any notable characteristics.
...
3. The name should align with the style and theme implied by existing color names
